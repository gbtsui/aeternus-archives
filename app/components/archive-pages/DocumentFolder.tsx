...
export default function DocumentFolder(props: DocumentFolderProps) {
    ...
    return (
        ...
        style={{
            transform: "translateY(calc(var(--i) * 12px)) scale(0.97)",
        ...
        >
            ...
            <div className={"relative inset-0 w-full h-full bg-amber-200"}>
                ...
                <div className={"absolute bg-amber-100 top-0 right-0 h-full w-[22vh] rounded-tl-md"}>
