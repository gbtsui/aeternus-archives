...
export const periodicTableElementsBasicData: Record<number, ElementBasicMetadata> = {
    ...
    20: {
        ...
        archiveDocuments: [
            {filename: "intake.html", title: "intake"},
            {filename: "initial-interview-record.html", title: "initial interview"},
        ]
    },
    ...
    15: {
        ...
        column: 15,
        row: 3,
        characterName: "Ambrose",
        archiveDocuments: [
            {filename: "personnel-file.html", title: "Personnel File"}
        ]
    },
